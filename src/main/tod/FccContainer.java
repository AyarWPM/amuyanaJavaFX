...
//import static main.tod.FccContainer.FccType.MIRROR;
//import static main.tod.FccContainer.FccType.NORMAL;
import static main.tod.FormulaContainer.Styles.SIMPLE;
...
public class FccContainer extends VBox {
    ...
    */
    ...
    public main.data.tod.containers.Container2 getMultiContainerParent(){
        return (main.data.tod.containers.Container2)getParent().getParent();
    }
    ...
    public void setKnobsPositions(){
        Point2D pointKnob0 = todController.getTod().sceneToLocal(knob0.localToScene(0,0));
        Point2D pointKnob1 = todController.getTod().sceneToLocal(knob1.localToScene(0,0));
        Point2D pointKnob2 = todController.getTod().sceneToLocal(knob2.localToScene(0,0));
        Point2D pointKnob3 = todController.getTod().sceneToLocal(knob3.localToScene(0,0));
    ...
    private Menu getMenu(){
        ...
        //conjunctionsWithFccMenu.getItems().addAll(appController.getListConjunctionsForMenu(getInclusion()));
...
/*
        ...
        muimTurnToFront.setOnAction(event -> getThis().getParentContainer3().toFront());

        Menu deployMenu = new Menu("Deploy");

        CheckMenuItem cmiDeployAntecedents = new CheckMenuItem("Deploy all antecedents");
        cmiDeployAntecedents.setOnAction(event -> getThis().getParentContainer3().deployAntecedents());

        CheckMenuItem cmiDeployDescendants = new CheckMenuItem("Deploy all descendants");
        cmiDeployDescendants.setOnAction(event -> getThis().getParentContainer3().deployDescendants());
