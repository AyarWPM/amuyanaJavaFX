...
import main.data.InclusionHasSyllogism;
import main.data.Syllogism;
import java.net.URL;
...
//            if(i.getInclusion().equals(particular)){
//                for(General g:listGenerals){
//                    if(g.getContainer2().equals(i)){
//                        tempConjunctions.add(g.getInclusion());
//                    }
//                }
//            }
